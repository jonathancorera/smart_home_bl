...
Widget _buildIcon(BuildContext context, IconData icon, {required bool isSecondary, required double? size}) =>
    Icon(icon, color: isSecondary ? $styles.colors.darkGray : $styles.colors.offWhite, size: size ?? 18);
...
class AppBtn extends StatelessWidget {
    ...
    _builder = (context) {
      ...
      Text? txt = text == null
          ...
          : Text(text.toUpperCase(),
              style: $styles.textStyles.bodyText, textHeightBehavior: const TextHeightBehavior(applyHeightToFirstAscent: false));
  ...
  Widget build(BuildContext context) {
    Color defaultColor = isSecondary ? $styles.colors.offWhite : $styles.colors.darkGray;
    Color textColor = isSecondary ? $styles.colors.offWhite : $styles.colors.offWhite;
